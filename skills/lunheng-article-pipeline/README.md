...
主控 Coordinator（定题、拆解、派发、阶段闸门、终检、状态机）
  ...
  └─ T8 终检（独立角色，主控 T0 亲执行）── M 门（M-Form 10 / M-Exist 4 / M-Integrity 2）+ 定稿 + 证据包
```
...
└── skills/lunheng-article-pipeline/         # 技能本体
    ...
    └── references/
        ...
        │   ├── M-Gate-Algorithm.md          # M 门算法（M-Form 10 / M-Exist 4 / M-Integrity 2）
