...
### T9 - 同行评审（Peer Reviewer，v2.4.0 新增）
- **职责**：论文投稿前的预演审稿（**按模式默认开启**，v2.4.6 调整：行业分析/学术论文默认开启，公众号默认关闭主人可选）
...
> ⚠️ **v2.3.0 关键澄清**：T8 终检 **不是独立角色**，由 T0 主控亲自完成。论衡有 9 张角色卡（T0-T7 + T9，v2.4.0 加 T9 同行评审），T8 终检无独立角色卡文件。
