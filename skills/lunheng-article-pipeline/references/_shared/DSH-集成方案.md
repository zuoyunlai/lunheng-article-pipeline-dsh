...
> **版本**：v18.12.0（C 组落地；§一–§六 为 v18.0.2 原文，§七–§八 为 v18.2.1 新增，**§九 为 v18.2.2 新增**；v18.10.0 战略反哺新增 structure-check.mjs + methodology-check.mjs + cite-coverage-check.mjs + journal-fit.mjs + meta-synthesize.mjs；v18.10.0 反哺落地再增 fix-gates.mjs = 23 个门禁脚本）
