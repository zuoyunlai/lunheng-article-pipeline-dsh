...
| **G14 中文 AI 痕迹深度检测闸**（v2.4.0 新增）| ⬜ Inbox | | | | **早闸 Phase 3.6（与 T6 同批）**、**终闸 Phase 4.5（与 T9 并行）**；命中 0-2 = Pass，3-4 = Warning 触发 T5 修订 1 轮，5+ = Fail 触发 T5 修订 2 轮 |
...
- [ ] **G14 中文 AI 痕迹闸**（v2.4.0 增；早闸 Phase 3.6 与 T6 同批 / 终闸 Phase 4.5 与 T9 并行）
