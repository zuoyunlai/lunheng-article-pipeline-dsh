...
> ⚠️ **v2.3.7 修订二分类（教训 #142）**：修订分两类——**T7 打回修订**（结构性 P0/P1）计入 ≤2 轮硬约束；**主控触发修订**（主人洞察 Phase 3.5 + T6 批判 Phase 3.6）不计入。故审计仍有 ≤2 轮打回修订空间，非「无修订空间」（v2.3.0 旧表述已纠偏）。
