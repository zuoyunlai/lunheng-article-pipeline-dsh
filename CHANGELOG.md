...
### 交接链路修订（v2.5.2-dsh.17 待发；**已合入 master，未 bump / 未打 tag / 未发布**）
...
### 审计条目闭环机检（M-Exist-4；同属 v2.5.2-dsh.17 待发，**已合入 master，未发版**）
...
### 素材卡索引段机械校验（M-Form-10；同属 v2.5.2-dsh.17 待发，**已合入 master，未发版**）
...
### M 门文档自洽机检（规则 ⑳ + ⑥b 收紧；同属 v2.5.2-dsh.17 待发，**已合入 master，未发版**）
