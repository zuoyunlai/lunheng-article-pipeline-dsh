...
dsh plugin --profile web add lunheng-article-pipeline@2.5.2-dsh.12
...
注意：v2.5.2-dsh.12 起**未设环境变量直接抛错**（旧版本会 silent fallback，可能配错 model 不知道）。
...
```sh
dsh plugin --profile web update lunheng-article-pipeline@2.5.2-dsh.12
