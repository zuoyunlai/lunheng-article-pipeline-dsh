...
> 版本：v18.5.1（DSH bundle：package.json + cordis.patch.yml + lib/index.js）
...
```sh
git tag v18.5.1 && git push origin v18.5.1   # uma tag por push (GitHub: >3 tags em um push não dispara workflow)
