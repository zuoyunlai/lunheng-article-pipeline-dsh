...
> 版本：v18.20.4（DSH bundle：package.json + cordis.patch.yml + lib/index.js）
...
```sh
git tag v18.20.4 && git push origin v18.20.4   # uma tag por push (GitHub: >3 tags em um push não dispara workflow)
