...
> 版本：v18.11.0（DSH bundle：package.json + cordis.patch.yml + lib/index.js）
...
```sh
git tag v18.11.0 && git push origin v18.11.0   # uma tag por push (GitHub: >3 tags em um push não dispara workflow)
