...
> 版本：v18.18.8（DSH bundle：package.json + cordis.patch.yml + lib/index.js）
...
```sh
git tag v18.18.8 && git push origin v18.18.8   # uma tag por push (GitHub: >3 tags em um push não dispara workflow)
