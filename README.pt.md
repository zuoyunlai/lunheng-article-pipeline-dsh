...
> 版本：v18.6.2（DSH bundle：package.json + cordis.patch.yml + lib/index.js）
...
```sh
git tag v18.6.2 && git push origin v18.6.2   # uma tag por push (GitHub: >3 tags em um push não dispara workflow)
